...
// 	printk(KERN_INFO "PARAG VIJAY INSIDE KVM_EMULATE_HYPERCALL");
...
// 		break;
//         case 0x0F3B:
// 		printk(KERN_INFO "PARAG VIJAY 0F3B");
// 	default:
// 		ret = -KVM_ENOSYS;
// 		break;
// 	}
...
int kvm_emulate_hypercall(struct kvm_vcpu *vcpu)
{
	...
	// vcpu->getctr2_counter = 1000;
	// printk(KERN_INFO "Parag Counter = %u",vcpu->getctr2_counter); //1000
	...
	case KVM_HC_KICK_CPU:
		...
		break;
	case 0x0F3B:
		printk("jsingh1_test1:test Test Case 2");
		printk(KERN_NOTICE "data_nr:0x%x\n ", (unsigned int)(nr));
